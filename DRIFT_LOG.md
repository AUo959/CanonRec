...
## Drift Entry — 2026-08-09 (prose-claim ledger: Union constitutional basis recovered)
- **Source:** `reports/recovery/data/prose_claim_ledger__2026-08-09.json` (1,044 claims / 108 entities)
- **Type:** recovered canon from prose claims
- **Entities affected:** `org_galactic_union`, `org_judicial_council`, `org_union_marshals`
- **Description:** The Galactic Union — the setting's primary polity — had **no `government` field at all**. Early-project prose carries its constitutional basis: a **federal, multi-species democracy** balancing power among planets, regions and species; a framework balancing **centralized federal power against planetary autonomy**; a legal framework built on **interstellar treaties, regional authority and centralized oversight**; and the formalization of the **Galactic Union Charter** (principles of governance, trade regulation, conflict resolution). None of it existed in canon. Also recovered: the Judicial Council's composition (**12 Justices**, appointed by the High Chancellor subject to Senate approval; interprets law, resolves inter-planetary disputes, ensures adherence to the Galactic Constitution) and the Marshals' institutional mandate (federal law-enforcement agency, galaxy-scale jurisdiction, budget set by the Senate).
- **Resolution:** RESOLVED — reconciled onto the three records after checking that canon held none of it elsewhere.
- **Two identity questions raised, neither asserted:** (1) the prose references a "**Galactic Constitution**" alongside the Galactic Union Charter — whether these are one instrument under two names or distinct is not established; (2) it names a "**Director of the Galactic Marshals**" while canon records Chief Marshal Vael Saros as "Leader of the Union Marshals" — whether that is the same office retitled is not established. Both recorded as open notes.
- **A false alarm avoided:** the prose calls the Chancellor "**Zylox Verrin**" where canon has "Zylox Rhaegos". Checking first showed *Zylox Verrin* is already a recorded **alias** on the canon record from an earlier salvage pass. No conflict; no action needed.
