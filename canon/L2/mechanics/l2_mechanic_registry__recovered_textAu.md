...
reproducible decision trace. Tests: `tests/test_mech_gov_001.py` (15) +
`tests/test_gumas_consequence_layer.py` (4) +
`tests/test_observatory_240_cycle.py` (10).
